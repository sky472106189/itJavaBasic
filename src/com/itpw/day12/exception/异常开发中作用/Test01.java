package com.itpw.day12.exception.异常开发中作用;
...
public class Test01 {
    public static void main(String[] args) {
        ...
        try{
            ...
            stack.push(new Object());
            stack.push(new Object());   //异常发生 try中后续程序无法执行
        ...
        try{
            ...
            stack2.push(new Person(1, "王五"));// 异常发生 try中后续无法发生
...
class Stack {
    ...
    public void push(Object obj) throws StackOperationException {
        if (num >= size) {
            throw new StackOperationException("栈已满，无法压栈");
//            System.out.println("栈已满，无法压栈");
    ...
    public Object pop() throws StackOperationException {
        if (num == 0) {
            throw new StackOperationException("栈为空，无法弹栈");
//            return "栈为空，无法弹栈";
        } else {
            return objs[--num];
        }
