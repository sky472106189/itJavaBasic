...
/*
    ...
    如Animal都有move方法，但是都通过各自子类的代码来执行
        "先是有一个Cat类，然后再有一个Bird类，观察后发现它们又类似之处，于是泛化
    出Animal类，这也体现了敏捷开发的思想，【通过重构改善既有代码的设计】"
        "只有小猫的时候，就设计一个动物类，就极有可能成为过度设计了，所以说，抽
    象类往往都是通过重构得来的，当然，如果你事先意识到多种分类的可能，那么事先就
    设计出抽象也是可以的"
*/
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            3.注意:如果执行的方法是子类特有的，那么多态后的对象无法执行子类
              特有的方法。此时需要向下转型(instanceof)，具体可以看a3的例子
