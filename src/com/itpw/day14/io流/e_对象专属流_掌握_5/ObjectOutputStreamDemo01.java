    ...
    3、序列化版本号有什么用？
        如果我们序列化Student，然后给Student类做修改，然后用OOS去反序列化，就会报错如下：
            ...
            local class incompatible:
                stream classdesc serialVersionUID = 2831870326451292969, （十年前）
                local class serialVersionUID = -4287548872569531787 （十年后）
...
public class ObjectOutputStreamDemo01 {
    public static void main(String[] args) throws Exception {
        ...
        ObjectOutputStream oos = new ObjectOutputStream
                (new FileOutputStream("src/com/itpw/day14io流resource/Student"));
        // 序列化对象
        oos.writeObject(s1);
